...
import { characterAreaControl, characterAreaControlFieldColumn, characterAreaControlText } from "../../styles/characterArea.css";
...
export const AudioRecorder = () => {
        ...
        return (
            <>
                <div className={characterAreaControl}>
                    <div className={characterAreaControlText}>{t("reference_voice_area_capture_instruction")}</div>
                </div>
                <div className={characterAreaControl}>
                    ...
                    <div className={characterAreaControlFieldColumn}>
                        ...
                        <div>
                            ...
                            >
                                {t("reference_voice_area_capture_start")}
                            </button>
                            <button
                                onClick={() => {
                                    onStopClicked();
                                ...
                                disabled={!audioRecorderState.audioRecorderStarted}
                            >
                                {t("reference_voice_area_capture_stop")}
                            </button>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            >
                                {t("reference_voice_area_upload_button_label")}
                            </button>
                        </div>
                    </div>
                </div>
    ...
    }, [audioInputSelector, audioRecorderState.audioRecorderStarted]);
    useEffect(() => {
