...
const EmotionColorRow = ({ emotion, index, voiceCharacter }: EmotionColorRowProps) => {
    const { t } = useTranslation();
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", margin: "8px 0", width: "100%", height: "100%" }}>
            ...
            <div className={colorButton} style={{ backgroundColor: color, color: getContrastColor(color) }}
                onClick={
                    async () => {
                        ...
                        const existEmotionColor = voiceCharacter.emotion_types.find(x => { return x.name === emotion.name })
...
export const EmotionColorDialog = (props: EmotionColorDialogProps) => {
    ...
    const newEmotionArea = useMemo(() => {
        ...
        return (
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", margin: "8px 0", width: "100%", height: "100%" }}>
                <div className={colorButton} style={{ backgroundColor: "#ffffff", color: getContrastColor("#ffffff") }}
                    onClick={
                        async () => {
                            const p = new Promise<string | null>((resolve) => {
                                setDialog2Props({
