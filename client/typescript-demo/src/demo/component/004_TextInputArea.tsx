    ...
    const area = useMemo(() => {
        ...
        if (gptSovitsModelVersion == "v4" || gptSovitsModelVersion == "v3" || gptSovitsModelVersion == "v2") {
            useAdvanceInputModeButton = (
                <button
                    ...
                    className={`${BasicButton({ active: useAdvanceInputMode, height: "short" })} ${normalButtonThema}`}
                >
                    advanced
                </button>
            );
                        ...
                        <>
                            ...
                            <div style={{ width: "100%", maxHeight: "5rem", overflowY: "auto", overflowX: "hidden" }}>
                                <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #ccc", fontSize: "0.7rem" }}>
                                    <thead>
                                        <tr>
                                            <th style={{ border: "1px solid #ccc", backgroundColor: "#f0f0f0" }}>
                                                {t("text_input_area_word_list_column_string")}
                                            </th>
                                            <th style={{ border: "1px solid #ccc", backgroundColor: "#f0f0f0" }}>
                                                {t("text_input_area_word_list_column_pronunciation")}
                                            </th>
                                            <th style={{ border: "1px solid #ccc", backgroundColor: "#f0f0f0" }}>
                                                {t("text_input_area_word_list_column_accent")}
                                            </th>
                                            <th style={{ border: "1px solid #ccc", backgroundColor: "#f0f0f0" }}>
                                                {t("text_input_area_word_list_column_mora_count")}
                                            </th>
                                            <th style={{ border: "1px solid #ccc", backgroundColor: "#f0f0f0" }}>
                                                {t("text_input_area_word_list_column_save")}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                {jpDictRecords.length === 0 && (
                                    <div style={{ padding: "10px", textAlign: "center", color: "#666" }}>{t("text_input_area_dict_records_empty")}</div>
                                )}
                            </div>
                        </>
                    );
        ...
        return (
            <div className={textInputArea}>
                <div className={SectionHeader()}>{t("text_input_area_title")}</div>
                ...
                <div style={{ display: "flex", flexDirection: "row", gap: "2rem", width: "100%", justifyContent: "space-between" }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: "5px", width: "45%" }}>
                        <div style={{ display: "flex", gap: "15px", alignItems: "flex-end" }}>
                            <div className={BasicLabel({ width: "large5" })}>{t("text_input_area_textarea-label")}</div>
                            {useAdvanceInputModeButton}
                        </div>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <button
                                id="text-input-area-submit-button"
                                onClick={async () => {
                                    setDialog2Props({
                                        title: t("wait_dialog_title_generating"),
                                        instruction: `${t("wait_dialog_instruction_generating")}`,
                    ...
                    <div style={{ display: "flex", flexDirection: "column", width: "45%" }}>
                        ...
                        <div className={BasicLabel({ width: "x-large" })}>
                            {t("text_input_area_generated_voice_label")}[{elapsedTime.toFixed(0)}ms]
                        </div>
